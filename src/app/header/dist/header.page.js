...
var HeaderPage = /** @class */ (function () {
    function HeaderPage(router, pushService, menu, authService, modalCtrl) {
        this.router = router;
    ...
    HeaderPage.prototype.menuOpened = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.menu.toggle()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    HeaderPage.prototype.goToNotify = function () {
        // this.pushService.init();
        this.router.navigate(['/notify']);
    };
    HeaderPage.prototype.openTestPage = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // @ts-ignore
    HeaderPage.prototype.returnLogo = function () {
